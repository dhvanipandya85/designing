                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3 col-md-5 col-5 mx-lg-auto">
                            <img src="{{asset('assets/images/sharing-design-ideas-with-family.jpg')}}" class="about-image about-image-small img-fluid" alt="">
                        </div>

                        <div class="col-lg-4 col-md-7 col-7">
                            <img src="{{asset('assets/images/living-room-interior-wall-mockup-warm-tones-with-leather-sofa-which-is-kitchen-3d-rendering.jpg')}}" class="about-image img-fluid" alt="">
                        </div>
                            ...
                            <div class="owl-carousel reviews-carousel">
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="{{asset('assets/images/avatar/pretty-blonde-woman-wearing-white-t-shirt.jpg')}}" class="avatar-image img-fluid" alt="">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="{{asset('assets/images/avatar/studio-portrait-emotional-happy-funny-smiling-boyfriend-man-with-heavy-beard-stands-with-arms-crossed-dressed-red-t-shirt-isolated-blue.jpg')}}" class="avatar-image img-fluid" alt="">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="{{asset('assets/images/avatar/portrait-beautiful-young-woman-standing-grey-wall.jpg')}}" class="avatar-image img-fluid" alt="">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="{{asset('assets/images/avatar/portrait-young-redhead-bearded-male-wears-white-t-shirt-keeps-his-eyes-closed-smiling-feels-happy-yellow.jpg')}}" class="avatar-image img-fluid" alt="">
                                ...
                                <div class="reviews-thumb">
                                    ...
                                    <div class="reviews-bottom reviews-bottom-up d-flex align-items-center">
                                        <img src="{{asset('assets/images/avatar/portrait-young-beautiful-woman-gesticulating.jpg')}}" class="avatar-image img-fluid" alt="">
